    ...
    if not os.path.exists('final_ultimate_model_gwo.h5'):
        ...
        if part_files:
            ...
            try:
                ...
                import subprocess
                result = subprocess.run(['python', 'combine_model.py'], capture_output=True, text=True)
...
class BrainStrokeDetector:
    ...
    def preprocess_image(self, image):
        """Preprocess uploaded image using PIL instead of OpenCV"""
        try:
    ...
    def create_brain_mask(self, img):
        """Create brain region mask using PIL/numpy instead of OpenCV"""
        try:
            ...
            # Simple thresholding (replace OpenCV Otsu)
