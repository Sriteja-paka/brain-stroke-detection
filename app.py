...
class BrainStrokeDetector:
    ...
    def load_models(self):
        """Load all required models - SIMPLIFIED without BiLSTM"""
        try:
    ...
    def predict_image(self, processed_img):
        """REAL PREDICTION with SHAP and Grad-CAM"""
        try:
            if not self.models_loaded:
...
def show_file_setup_page():
    ...
    st.info("""
    💡 **This version includes both SHAP and Grad-CAM with robust error handling!**
